...
## Ratio of Means (aka Response Ratio)
```{r}
RR_effect_sizes <- escalc( # Function for calculating effect sizes.
    "ROM",
    # Specify the effect size we want to calculate. In this case ROM for the Response Ratio or Ratio of Means
    m1i = mean_invaded,
    # mean richness at invaded sites
    n1i = sample_size_invaded,
    # invaded site sample size
