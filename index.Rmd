...
There are many more ways to display and summarize the data included in this CSV file.  For now though, we'll move onto the meta-analysis and focus on the numerical variables that are  the key ingredients for meta-analysis (mean, standard deviation, and sample size).

--- 
## Acknowledgements {-}
This book was created using the **bookdown** [@xie_bookdown_2019]. Thanks to the [Lockwood Lab](https://www.lockwoodlab.com).
