...
```{r}
forest_plot_continent_and_island <- forest(mix_effect_island_or_continent$b,
                                     ci.lb = mix_effect_island_or_continent$ci.lb,
                                     ci.ub = mix_effect_island_or_continent$ci.ub,
                                     # ilab = oa_subgroup_sample_size,
                                     #ilab.xpos = c(-.7),
                                     annotate = TRUE,
                                     xlab = "ln(Response Ratio)",
                                     slab = c("Continent", "Island"),
                                     cex = 2,
                                     digits = 2,
                                     col = "#482677FF"
)

text(-.7, rev(seq(3:1)), continent_and_island_sample_size, col = "#482677FF", cex = 2)
op <- par(cex=2, font=2)
text(-1.25, 4.2, "Study Location")
